...
call :FindMSBuild 14.0 || call :FindMSBuild 12.0 || call :FindMSBuild 4.0
...
reg.exe query "HKLM\SOFTWARE\Microsoft\MSBuild\ToolsVersions\%1" /v MSBuildToolsPath > nul 2>&1
if errorlevel 1 exit /b %ERRORLEVEL%
for /f "skip=2 tokens=2,*" %%A in ('reg.exe query "HKLM\SOFTWARE\Microsoft\MSBuild\ToolsVersions\%1" /v MSBuildToolsPath') do SET MSBUILDDIR=%%B
